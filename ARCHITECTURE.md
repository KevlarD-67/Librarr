...
> shipping-version references below were bumped for the `1.2.0-beta`
...
- `azure-pipelines.yml:22` — `majorVersion: '1.2.0-beta'`.
...
The product currently versions itself at `1.2.0-beta`
...
- `majorVersion: '1.2.0-beta'` — the *real* shipping version
